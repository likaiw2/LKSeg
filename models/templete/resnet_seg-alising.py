'''
    This is copied from seg-aliasing model.
    "https://github.com/Linwei-Chen/Seg-Aliasing/"
    
    The main contribution is two modules:
    
    - De-aliasing Filter (DAF)
        The DAF module precisely removes frequencies above the Nyquist frequency before downsampling operations. It operates by:

        Calculating equivalent sampling rate for each layer
        Determining Nyquist frequency threshold
        Filtering high-frequency components that cause aliasing
        Preserving essential low-frequency information
        
    - Frequency Mixing (FreqMix)
        The FreqMix module dynamically selects and combines high-frequency components within encoder blocks. It provides:

        Adaptive frequency component selection
        Dynamic mixing of low and high-frequency information
        Enhanced feature representation without aliasing artifacts
        
    more details can be found in "https://deepwiki.com/Linwei-Chen/Seg-Aliasing#frequency-mixing-freqmix"
'''
